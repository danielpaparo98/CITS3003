...
display( void )
{
    ...
    mat3 xyRotateMultipliers = mat3( vec3(cos(angle), sin(angle), 1.0),
                                     vec3(-sin(angle), cos(angle),1.0),
                                     vec3(0.0,         0.0,        1.0));

    glUniformMatrix3fv( matrix, 1, GL_TRUE, xyRotateMultipliers );
    ...
    mat3 yzRotateMultipliers = mat3(
                                     vec3(1.0,         0.0,        0.0),
                                     vec3(0.0,  cos(angle), sin(angle)),
                                     vec3(0.0, -sin(angle), cos(angle)) );

    glUniformMatrix3fv( matrix, 1, GL_TRUE, yzRotateMultipliers );
    glDrawArrays( GL_TRIANGLES, 0, NumVertices );
    glutSwapBuffers();
}
