...
display( void )
{
    ...
    mat3 xyRot = mat3( vec3(cos(angle), -sin(angle), 0.0),
                                     vec3(sin(angle), cos(angle),0.0),
                                     vec3(0.0,         0.0,        1.0));

    
    mat3 xzRot = mat3(              vec3(cos(angle),  0.0, sin(angle)),
                                    vec3(0.0,         1.0,        0.0),
    ...
    glUniformMatrix3fv( matrix, 1, GL_TRUE, yzRot * xzRot *shrinkX);
...
main( int argc, char **argv )
{
    ...
    glutCreateWindow( "Rotating Cube B" );
